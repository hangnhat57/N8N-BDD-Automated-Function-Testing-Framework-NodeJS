...
async function createPath() {
	...
	baseLinePath = `${process.cwd()}/visual-baseline/${await browserdata.browser.name}-${await browserdata.platform.name}/`;
	visualReport = `${process.cwd()}/reports/visual-report/${await browserdata.browser.name}-${await browserdata.platform.name}/`;
